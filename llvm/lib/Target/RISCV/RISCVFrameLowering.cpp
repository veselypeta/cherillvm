...
static void emitSCSPrologue(MachineFunction &MF, MachineBasicBlock &MBB,
  ...
  // cincoffset/addi    (c)gp, (c)gp, [4|8|16]
  // s[w|d|c]           (c)ra, -[4|8|16](cgp)
  unsigned IncrInstr = IsPureCapABI ? RISCV::CIncOffsetImm : RISCV::ADDI;
  BuildMI(MBB, MI, DL, TII->get(IncrInstr))
      .addReg(SCSPReg, RegState::Define)
      .addReg(SCSPReg)
      .addImm(SlotSize)
      .setMIFlag(MachineInstr::FrameSetup);
  unsigned StoreInstr = IsPureCapABI ? (IsRV64 ? RISCV::CSC_128 : RISCV::CSC_64)
...
static void emitSCSEpilogue(MachineFunction &MF, MachineBasicBlock &MBB,
  ...
  // cincoffset/addi   (c)gp, (c)gp, -[4|8|16]
  unsigned LoadInstr = IsPureCapABI ? (IsRV64 ? RISCV::CLC_128 : RISCV::CLC_64)
