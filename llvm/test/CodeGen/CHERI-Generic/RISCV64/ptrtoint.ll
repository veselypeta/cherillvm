...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+xcheri,+cap-mode,+f,+d -riscv-disable-regalloc-hints < %s | FileCheck %s
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi lp64d -mattr=+xcheri,+f,+d -riscv-disable-regalloc-hints < %s | FileCheck %s --check-prefix=HYBRID
