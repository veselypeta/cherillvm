...
; RUN: llc -mtriple=mips64 -mcpu=cheri128 -mattr=+cheri128 --relocation-model=pic -target-abi purecap -riscv-disable-regalloc-hints < %s | FileCheck %s
; RUN: llc -mtriple=mips64 -mcpu=cheri128 -mattr=+cheri128 --relocation-model=pic -target-abi n64 -riscv-disable-regalloc-hints < %s | FileCheck %s --check-prefix=HYBRID
