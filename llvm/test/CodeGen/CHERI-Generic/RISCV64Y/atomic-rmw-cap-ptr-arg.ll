...
; PURECAP-ATOMICS-NEXT:    amoswap.y.aqrl ca0, ca1, (ca0)
...
; PURECAP-ATOMICS:       # %bb.0:
; PURECAP-ATOMICS-NEXT:    amoswap.y ca0, ca1, (ca0)
; PURECAP-ATOMICS-NEXT:    ret
;
...
; PURECAP-ATOMICS:       # %bb.0:
; PURECAP-ATOMICS-NEXT:    amoswap.y.aq ca0, ca1, (ca0)
; PURECAP-ATOMICS-NEXT:    ret
;
...
; PURECAP-ATOMICS:       # %bb.0:
; PURECAP-ATOMICS-NEXT:    amoswap.y.rl ca0, ca1, (ca0)
; PURECAP-ATOMICS-NEXT:    ret
;
...
; PURECAP-ATOMICS-NEXT:    lr.y.aqrl ca2, (ca0)
; PURECAP-ATOMICS-NEXT:    cadd ca3, ca2, a1
; PURECAP-ATOMICS-NEXT:    sc.y.aqrl a3, ca3, (ca0)
...
; PURECAP-LIBCALLS-NEXT:    scbndsi cs1, ca0, 16
...
; PURECAP-LIBCALLS-NEXT:    caddi ca0, csp, 0
; PURECAP-LIBCALLS-NEXT:    scbndsi cs0, ca0, 16
