...
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+xcheri,+cap-mode,+f -riscv-disable-regalloc-hints < %s | FileCheck %s
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi ilp32f -mattr=+xcheri,+f -riscv-disable-regalloc-hints < %s | FileCheck %s --check-prefix=HYBRID
