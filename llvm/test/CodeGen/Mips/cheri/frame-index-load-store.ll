...
define ptr addrspace(200) @load_store_ptr_to_stack(ptr addrspace(200) %arg1, ptr addrspace(200) %arg2) addrspace(200) #0 {
...
; Function Attrs: nounwind
define i64 @load_store_stack_i64(i64 %arg, ptr addrspace(200) %padding) addrspace(200) #0 {
...
; Function Attrs: nounwind
define i8 @load_store_stack_i8(i8 %arg, ptr addrspace(200) %padding) addrspace(200) #0 {
...
; Function Attrs: nounwind
define i64 @load_store_stack_i32_truncstore(i64 %arg, ptr addrspace(200) %padding) addrspace(200) #0 {
...
; Function Attrs: nounwind
define i64 @load_store_stack_i32_sext(i32 %arg, ptr addrspace(200) %padding) addrspace(200) #0 {
