...
; Function Attrs: noinline nounwind
define linkonce_odr i32 @_ZN1A7nonvirtEv(ptr addrspace(200) %this) addrspace(200) #0 align 2 {
entry:
  unreachable
}

; Function Attrs: noinline nounwind
define i32 @_Z12call_nonvirtP1A(ptr addrspace(200) %a) addrspace(200) #0 {
entry:
  unreachable
}

; Function Attrs: noinline nounwind
define i32 @_Z9call_virtP1A(ptr addrspace(200) %a) addrspace(200) #0 {
entry:
  unreachable
}

; Function Attrs: noinline nounwind
define i32 @_Z18call_local_nonvirtP1A(ptr addrspace(200) %a) addrspace(200) #0 {
entry:
  unreachable
}

; Function Attrs: noinline nounwind
define linkonce_odr i32 @_ZN1A8nonvirt2Ev(ptr addrspace(200) %this) addrspace(200) #0 align 2 {
entry:
  unreachable
}
...
; Function Attrs: noinline nounwind
define i32 @_Z15call_local_virtP1A(ptr addrspace(200) %a) addrspace(200) #0 {
entry:
  unreachable
}

; Function Attrs: noinline nounwind
define i32 @_Z17call_local_fn_ptrP1A(ptr addrspace(200) %a) addrspace(200) #0 {
entry:
  unreachable
}
...
; Function Attrs: noinline nounwind
define linkonce_odr void @_ZN1AC2Ev(ptr addrspace(200) %this) unnamed_addr addrspace(200) #0 align 2 {
entry:
  unreachable
}

; Function Attrs: noinline nounwind
define linkonce_odr i32 @_ZN1A4virtEv(ptr addrspace(200) %this) unnamed_addr addrspace(200) #0 align 2 {
entry:
  unreachable
}

; Function Attrs: noinline nounwind
define linkonce_odr i32 @_ZN1A5virt2Ev(ptr addrspace(200) %this) unnamed_addr addrspace(200) #0 align 2 {
entry:
  unreachable
}
