...
define internal void @test(ptr addrspace(200) align 16 dereferenceable(16) %ctr) unnamed_addr addrspace(200) #0 {
; CHECK-LABEL: test:
; CHECK:       # %bb.0: # %start
...
; Function Attrs: nounwind
define internal void @test2(ptr addrspace(200) align 16 dereferenceable(16) %ctr) unnamed_addr addrspace(200) #0 {
; CHECK-LABEL: test2:
; CHECK:       # %bb.0: # %start
...
; Function Attrs: nounwind
define internal void @test3(ptr addrspace(200) align 16 dereferenceable(16) %ctr) unnamed_addr addrspace(200) #0 {
; CHECK-LABEL: test3:
; CHECK:       # %bb.0: # %start
...
; Function Attrs: nounwind
define internal { ptr addrspace(200), ptr addrspace(200), ptr addrspace(200), ptr addrspace(200) } @get_tuple_cap_impl() unnamed_addr addrspace(200) #0 {
...
; CHECK-NEXT:    cjr $c17
; CHECK-NEXT:    nop
  ret { ptr addrspace(200), ptr addrspace(200), ptr addrspace(200), ptr addrspace(200) } { ptr addrspace(200) inttoptr (i64 10 to ptr addrspace(200)), ptr addrspace(200) inttoptr (i64 20 to ptr addrspace(200)), ptr addrspace(200) inttoptr (i64 30 to ptr addrspace(200)), ptr addrspace(200) inttoptr (i64 40 to ptr addrspace(200)) }
}
