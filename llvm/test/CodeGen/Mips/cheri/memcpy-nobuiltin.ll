...
define void @memcpy_too_big_unaligned(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
...
; Function Attrs: noinline nounwind
define void @memcpy_aligned(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
...
; Function Attrs: noinline nounwind
define void @memcpy_aligned_must_preserve_tags(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
...
; Function Attrs: noinline nounwind
define void @memcpy_underaligned_must_preserve_tags(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
...
; Function Attrs: noinline nounwind
define void @memmove_too_big_unaligned(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
...
; Function Attrs: noinline nounwind
define void @memmove_aligned(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
...
; Function Attrs: noinline nounwind
define void @memmove_underaligned_must_preserve_tags(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
...
; Function Attrs: noinline nounwind
define void @memmove_aligned_must_preserve_tags(ptr addrspace(200) %dst, ptr addrspace(200) %src) #0 {
entry:
