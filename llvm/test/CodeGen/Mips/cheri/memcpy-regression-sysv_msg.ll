...
%struct.blam = type { %struct.widget, ptr, ptr, i64, i64, i64, i32, i32, i64, i64, i64 }
%struct.widget = type { i32, i32, i32, i32, i16, i16, i64 }
%struct.foo = type { %struct.widget, ptr addrspace(200), ptr addrspace(200), i64, i64, i64, i32, i32, i64, i64, i64, [8 x i8] }

; Function Attrs: nounwind
define dso_local void @baz() #0 !dbg !4 {
; CHECK-LABEL: baz:
; CHECK:       # %bb.0: # %bb
...
bb:
  ...
  %tmp2 = getelementptr inbounds %struct.blam, ptr %tmp, i32 0, i32 0, !dbg !8
  %tmp3 = getelementptr inbounds %struct.foo, ptr %tmp1, i32 0, i32 0, !dbg !8
  %tmp4 = bitcast ptr %tmp2 to ptr, !dbg !8
  %tmp5 = bitcast ptr %tmp3 to ptr, !dbg !8
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %tmp4, ptr align 32 %tmp5, i64 32, i1 false), !dbg !8
  ret void
}
