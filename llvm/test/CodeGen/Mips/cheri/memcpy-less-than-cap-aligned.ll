...
; Function Attrs: nocallback nofree nounwind willreturn memory(argmem: readwrite)
declare void @llvm.memmove.p200.p200.i64(ptr addrspace(200) nocapture writeonly, ptr addrspace(200) nocapture readonly, i64, i1 immarg) addrspace(200) #0

; Function Attrs: nounwind willreturn memory(none)
declare ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200), i64) addrspace(200) #1

; Function Attrs: nounwind
define void @dst_align1_should_call_memcpy(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) #2 {
entry:
...
; Function Attrs: nounwind
define void @dst_align2_should_call_memcpy(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) #2 {
entry:
...
; Function Attrs: nounwind
define void @dst_align4_should_call_memcpy(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) #2 {
entry:
...
; Function Attrs: nounwind
define void @dst_align8_should_call_memcpy(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) #2 {
entry:
...
; Function Attrs: nounwind
define void @dst_align16_can_be_inlined_128(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) #2 {
entry:
...
; Function Attrs: nounwind
define void @dst_align32_can_be_inlined_always(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) #2 {
entry:
...
attributes #2 = { nounwind "use-soft-float"="true" }
