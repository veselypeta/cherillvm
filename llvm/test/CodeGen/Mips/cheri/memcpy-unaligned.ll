...
define void @spgFormLeafTuple() addrspace(200) #1 {
...
; Function Attrs: noinline nounwind
define void @copy_nocaps() addrspace(200) #1 {
...
; Function Attrs: noinline nounwind
define void @align2_should_call_memcpy() addrspace(200) #1 {
...
entry:
  ...
  store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 1), ptr addrspace(200) %c, align 16
  %0 = load ptr addrspace(200), ptr addrspace(200) @b, align 16
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) noundef nonnull align 2 dereferenceable(16) %0, ptr addrspace(200) noundef nonnull align 16 dereferenceable(16) %c, i64 16, i1 false)
  ret void
...
; Function Attrs: noinline nounwind
define void @align4_should_call_memcpy() addrspace(200) #1 {
...
entry:
  ...
  store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 1), ptr addrspace(200) %c, align 16
  %0 = load ptr addrspace(200), ptr addrspace(200) @b, align 16
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) noundef nonnull align 4 dereferenceable(16) %0, ptr addrspace(200) noundef nonnull align 16 dereferenceable(16) %c, i64 16, i1 false)
  ret void
...
; Function Attrs: noinline nounwind
define void @align8_should_call_memcpy() addrspace(200) #1 {
...
entry:
  ...
  store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 1), ptr addrspace(200) %c, align 16
  %0 = load ptr addrspace(200), ptr addrspace(200) @b, align 16
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) noundef nonnull align 8 dereferenceable(16) %0, ptr addrspace(200) noundef nonnull align 16 dereferenceable(16) %c, i64 16, i1 false)
  ret void
...
; Function Attrs: noinline nounwind
define void @align16_can_be_inlined() addrspace(200) #1 {
...
entry:
  %0 = load ptr addrspace(200), ptr addrspace(200) @b, align 16
  store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 1), ptr addrspace(200) %0, align 16
  ret void
