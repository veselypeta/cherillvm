...
declare ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200), i64) addrspace(200) #0
...
define ptr addrspace(200) @setoffset(i64 %arg) addrspace(200) #1 {
...
; Function Attrs: nounwind
define ptr addrspace(200) @pass_var(i64 %arg) addrspace(200) #1 {
