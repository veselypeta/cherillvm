...
define i32 @test(ptr %a, ...) local_unnamed_addr #0 {
entry:
  %ap = alloca ptr, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %ap) #0
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ap) #0
  ret i32 0
