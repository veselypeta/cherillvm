...
define chericcallcc ptr addrspace(200) @cgetdata(ptr addrspace(200) inreg readnone %c.coerce0, ptr addrspace(200) inreg nocapture readnone %c.coerce1) #0 {
...
; Function Attrs: nounwind memory(none)
define chericcallcc i32 @cgetnumber(ptr addrspace(200) inreg nocapture readnone %c.coerce0, ptr addrspace(200) inreg nocapture readnone %c.coerce1) #0 {
