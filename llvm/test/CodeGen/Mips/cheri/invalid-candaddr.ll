...
define signext i32 @cap_covers_pages_regression(ptr addrspace(200) %cap, i64 zeroext %size) local_unnamed_addr #0 {
...
; OPTNONE-NEXT:    and $3, $1, $2
; OPTNONE-NEXT:    cgetlen $2, $c1
; OPTNONE-NEXT:    cgetoffset $4, $c1
; OPTNONE-NEXT:    sltu $1, $2, $4
; OPTNONE-NEXT:    xori $1, $1, 1
; OPTNONE-NEXT:    dsubu $2, $2, $4
; OPTNONE-NEXT:    sltu $2, $2, $3
; OPTNONE-NEXT:    xori $2, $2, 1
...
; Function Attrs: nounwind memory(none)
define ptr addrspace(200) @test_basic_andaddr_combine_ptradd(ptr addrspace(200) %cap, i64 zeroext %size) #0 {
...
; Function Attrs: nounwind memory(none)
define ptr addrspace(200) @fold_setaddr(ptr addrspace(200) %cap, i64 zeroext %size) #0 {
