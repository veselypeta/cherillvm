...
define hidden void @_thr_umutex_init_undef(ptr addrspace(200) %arg) addrspace(200) #1 {
...
define hidden void @_thr_umutex_init_zero(ptr addrspace(200) %arg) addrspace(200) #1 {
