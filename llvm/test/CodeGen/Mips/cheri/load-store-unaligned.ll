...
; Function Attrs: nounwind memory(read) uwtable
define ptr addrspace(200) @load_unaligned(ptr addrspace(200) %unaligned) local_unnamed_addr addrspace(200) #0 {
...
; Function Attrs: nounwind memory(read) uwtable
define void @store_unaligned(ptr addrspace(200) %unused, ptr addrspace(200) %unaligned, ptr addrspace(200) %value) local_unnamed_addr addrspace(200) #0 {
...
entry:
  %r.0..sroa_cast = bitcast ptr addrspace(200) %unaligned to ptr addrspace(200)
  store ptr addrspace(200) %value, ptr addrspace(200) %r.0..sroa_cast, align 4, !dbg !5
  ret void
}

; This should be turned into a memmove:
; Function Attrs: nounwind memory(read) uwtable
define void @store_of_unaligned_load(ptr addrspace(200) %src, ptr addrspace(200) %dest, ptr addrspace(200) %value) local_unnamed_addr addrspace(200) #0 {
...
; Function Attrs: nounwind willreturn memory(none)
declare i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200)) addrspace(200) #1

attributes #0 = { nounwind memory(read) uwtable }
...
!0 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus, file: !1, isOptimized: true, runtimeVersion: 0, emissionKind: LineTablesOnly, enums: !2, nameTableKind: None)
!1 = !DIFile(filename: "sroa-libunwind.cxx", directory: "/foo")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 5}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !DILocation(line: 9, column: 3, scope: !6)
!6 = distinct !DISubprogram(name: "store_unaligned", scope: !1, file: !1, line: 7, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !2)
