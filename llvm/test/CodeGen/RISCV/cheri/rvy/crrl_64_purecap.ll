...
; RV64PURECAP-NEXT:    addiy csp, csp, -16
; RV64PURECAP-NEXT:    .cfi_def_cfa_offset 16
; RV64PURECAP-NEXT:    yamask a1, a0
...
entry:
  ...
  store i32 %len, ptr addrspace(200) %len.addr, align 4
  %0 = load i32, ptr addrspace(200) %len.addr, align 4
