...
;; `x.tag ? x.addr : 0`
; RUN: %riscv64_cheri_purecap_llc -riscv-disable-regalloc-hints -mattr=+xcheri-v9-semantics < %s | FileCheck %s --check-prefix=PURECAP
; RUN: %riscv64_cheri_llc -riscv-disable-regalloc-hints -mattr=+xcheri-v9-semantics < %s | FileCheck %s --check-prefix=HYBRID
