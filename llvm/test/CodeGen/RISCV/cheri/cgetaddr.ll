...
; RUN: %riscv64_cheri_purecap_llc -riscv-disable-regalloc-hints < %s | FileCheck %s
;; Check that we can emit an object file in addition to textual assembly.
; RUN: %riscv64_cheri_purecap_llc -riscv-disable-regalloc-hints -filetype=obj < %s -o /dev/null
