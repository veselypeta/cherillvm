...
# RUN: llvm-mc -triple riscv64 -mattr=+y,+cap-mode %s -o - | FileCheck %s --check-prefix=ZCHERI
...
# CHECK-NEXT:     auipcc ct0, %pcrel_hi(foo)
# XCHERI:    cincoffset ct0, ct0, %pcrel_lo(.Lpcrel_hi1)
# ZCHERI:    addiy      ct0, ct0, %pcrel_lo(.Lpcrel_hi1)
cllc ct0, foo
